...
public class ProductService {
    ...
    public void create(String name, Double price, Integer discount, Integer stock, Integer weight, MeasurementType measurementType, Integer productTypeId, Integer brandId, MultipartFile file) throws MiException {
    ...
    private void validateDuplicate(String name, Integer weight, Integer productTypeId, Integer brandId) throws MiException{
